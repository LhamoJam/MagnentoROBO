...
#ifndef ARTSCRIPT_INTERFACES__SRV__DETAIL__SERVO_SINGLE__FUNCTIONS_H_
#define ARTSCRIPT_INTERFACES__SRV__DETAIL__SERVO_SINGLE__FUNCTIONS_H_
...
/// Initialize srv/ServoSingle message.
/**
...
/// Finalize srv/ServoSingle message.
/**
...
/// Create srv/ServoSingle message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * artscript_interfaces__srv__ServoSingle_Request__init().
...
/// Destroy srv/ServoSingle message.
/**
 * It calls
 * artscript_interfaces__srv__ServoSingle_Request__fini()
...
/// Initialize array of srv/ServoSingle messages.
/**
...
/// Finalize array of srv/ServoSingle messages.
/**
 * It calls
 * artscript_interfaces__srv__ServoSingle_Request__fini()
...
/// Create array of srv/ServoSingle messages.
/**
 * It allocates the memory for the array and calls
 * artscript_interfaces__srv__ServoSingle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ServoSingle messages.
/**
 * It calls
 * artscript_interfaces__srv__ServoSingle_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * artscript_interfaces__srv__ServoSingle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_artscript_interfaces
...
/**
 * It calls
 * artscript_interfaces__srv__ServoSingle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_artscript_interfaces
...
/**
 * It allocates the memory for the array and calls
 * artscript_interfaces__srv__ServoSingle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_artscript_interfaces
...
/**
 * It calls
 * artscript_interfaces__srv__ServoSingle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARTSCRIPT_INTERFACES__SRV__DETAIL__SERVO_SINGLE__FUNCTIONS_H_
