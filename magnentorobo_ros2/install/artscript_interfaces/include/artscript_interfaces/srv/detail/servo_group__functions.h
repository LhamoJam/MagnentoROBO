...
#ifndef ARTSCRIPT_INTERFACES__SRV__DETAIL__SERVO_GROUP__FUNCTIONS_H_
#define ARTSCRIPT_INTERFACES__SRV__DETAIL__SERVO_GROUP__FUNCTIONS_H_
...
/// Initialize srv/ServoGroup message.
/**
...
/// Finalize srv/ServoGroup message.
/**
...
/// Create srv/ServoGroup message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * artscript_interfaces__srv__ServoGroup_Request__init().
...
/// Destroy srv/ServoGroup message.
/**
 * It calls
 * artscript_interfaces__srv__ServoGroup_Request__fini()
...
/// Initialize array of srv/ServoGroup messages.
/**
...
/// Finalize array of srv/ServoGroup messages.
/**
 * It calls
 * artscript_interfaces__srv__ServoGroup_Request__fini()
...
/// Create array of srv/ServoGroup messages.
/**
 * It allocates the memory for the array and calls
 * artscript_interfaces__srv__ServoGroup_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ServoGroup messages.
/**
 * It calls
 * artscript_interfaces__srv__ServoGroup_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * artscript_interfaces__srv__ServoGroup_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_artscript_interfaces
...
/**
 * It calls
 * artscript_interfaces__srv__ServoGroup_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_artscript_interfaces
...
/**
 * It allocates the memory for the array and calls
 * artscript_interfaces__srv__ServoGroup_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_artscript_interfaces
...
/**
 * It calls
 * artscript_interfaces__srv__ServoGroup_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARTSCRIPT_INTERFACES__SRV__DETAIL__SERVO_GROUP__FUNCTIONS_H_
