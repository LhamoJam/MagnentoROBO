...
bool artscript_interfaces__msg__infraredstrain__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("artscript_interfaces.msg._infraredstrain.Infraredstrain", full_classname_dest, 55) == 0);
  }
...
PyObject * artscript_interfaces__msg__infraredstrain__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("artscript_interfaces.msg._infraredstrain");
